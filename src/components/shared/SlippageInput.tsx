...
import { defaultSlippage, minSlippage, safeModeDisabledMaxSlippage, safeModeEnabledMaxSlippage } from "@/lib/constants";
...
const SlippagePopover: React.FC<SlippageInputProps> = ({
    ...
    return (
        <Input
            className="h-6 w-[3.5rem] no-arrows slippage-input border-0 shadow-sm"
