...
export const explorer_url = "https://snowscan.xyz";
...
export const sample_token_list: TokenList = {
  "0xAVAX": {
    address: "0xAVAX",
    name: "AVAX",
    ticker: "AVAX",
...
export const LFJ_ROUTER_ADDRESS = "0x60aE616a2155Ee3d9A68541Ba4544862310933d4";

export const LFJ_ROUTER_ABI = [
  {
    inputs: [
...
export const LFJ_FACTORY_ADDRESS = "0x9Ad6C38BE94206cA50bb0d90783181662f0Cfa10";

export const LFJ_FACTORY_ABI = [
  {
    inputs: [
...
export const PHARAOH_FACTORY_ABI = [
  ...
  },
  {
    ...
    name: "getPoolFeeSplit",
    outputs: [{ internalType: "uint8", name: "_poolFeeSplit", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [
      { internalType: "uint8", name: "_toFees", type: "uint8" },
      { internalType: "uint8", name: "_toTreasury", type: "uint8" },
    ],
    name: "setFeeSplit",
    outputs: [],
    stateMutability: "nonpayable",
